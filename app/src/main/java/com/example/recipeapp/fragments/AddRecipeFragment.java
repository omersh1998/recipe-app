...
public class AddRecipeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        searchView = rootView.findViewById(R.id.ingredient_search_bar);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String s) {
                ...
                if (ingredientsAdapter == null) {
                    ingredientsAdapter = new IngredientsAdapter(getActivity(), filtered, ingredientsRef, userRef, userId);
                    ingredientsRecyclerView.setAdapter(ingredientsAdapter);
                } else {
                    ingredientsAdapter.setIngredientList(filtered);
                }
                return false;
            }
        });
        ...
        addRecipeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (homeActivity.chosenIngredientIndexes.size() > 0) {
        ...
        recipeRef.child(key).setValue(recipe)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        homeActivity.chosenIngredientIndexes.clear();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
    ...
    private ArrayList<Ingredient> onSaveRecipeButtonClick() {
        ...
        for (int i = 0; i < homeActivity.chosenIngredientIndexes.size(); i++) {
            int ingredientIndex = homeActivity.chosenIngredientIndexes.get(i);
            String amount = ingredientsAdapter.getEditTextText(ingredientIndex);
            String name = ingredients.get(ingredientIndex).getName();
            ingredientsToAdd.add(new Ingredient(name, amount));
        }
        ...
        ingredientsRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ingredientSnapshot : dataSnapshot.getChildren()) {
                    ...
                    ingredients.add(new Ingredient(ingredientValue, null));
                }
                ...
                // Initialize or update the adapter
                if (ingredientsAdapter == null) {
                    ingredientsAdapter = new IngredientsAdapter(getActivity(), ingredients, ingredientsRef, userRef, userId);
                    ingredientsRecyclerView.setAdapter(ingredientsAdapter);
                } else {
